package com.kafka_test.demo.Service;
...
//        CompletableFuture<SendResult<String, Object>> future = template.send("sping-kafka-4", message);
...
//    }
    ...
    public void sendEventToTopic(Customer customer){
      try {
          CompletableFuture<SendResult<String, Object>> future = template.send("sping-kafka-4", customer);
          future.whenComplete((result, ex) -> {
